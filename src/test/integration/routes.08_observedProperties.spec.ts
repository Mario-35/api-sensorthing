...
const docs: IApiDoc[] = [];
const entity: IEntityProperty = _ENTITIES.ObservedProperties;
let index = 10;
        ...
        it(`Retrieve a ${entity.name} with inline related enities using $expand query option.`, (done) => {
            ...
            chai.request(server)
                ...
                .end((err: any, res: any) => {
                    ...
                    res.status.should.equal(200);
                    res.type.should.equal("application/json");
                    res.body.should.include.keys(_ENTITIES.Sensors.testsKeys.filter((elem) => elem !== "Datastreams@iot.navigationLink"));
