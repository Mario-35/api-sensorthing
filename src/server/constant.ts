  ...
  Multidatastreams: {
    ...
    columns: {
      ...
      properties: {
        create: "jsonb NULL",
        comment:
          "The detailed description of the multi_datastream. The data type is defined by encodingType.",
      },
    },
    excludeColumn: ["id"],
    relations: {
    ...
    constraints: {
      ...
      multi_datastream_sensor_id_fkey:
        'FOREIGN KEY ("sensor_id") REFERENCES "sensor"("id") ON UPDATE CASCADE ON DELETE CASCADE',
      multi_datastream_thing_id_fkey:
        'FOREIGN KEY ("thing_id") REFERENCES "thing"("id") ON UPDATE CASCADE ON DELETE CASCADE',
    },
    indexes: {
      multi_datastream_sensor_id:
        'ON public."multi_datastream" USING btree ("sensor_id")',
      multi_datastream_thing_id:
        'ON public."multi_datastream" USING btree ("thing_id")',
    },
    testsKeys: [
      "@iot.id",
      "name",
  ...
  Observations: {
    ...
    columns: {
      ...
      featureofinterest_id: {
        ...
        comment:
          "mandatory (If it is not provided it will be automatically created based on the Location of associated Thing)",
      },
    },
    constraints: {
